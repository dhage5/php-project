     ...
     <div class="container">
      ...
      <h1 class="text-white bg-dark text-center">
        Image Update</h1>
         ...
         <form action="updateimage.php?id=<?php echo $row['id']; ?>&table=test&page=viewanand.php" method="post" enctype="multipart/form-data">
          ...
          <a href="view-all-data.php" class="btn btn-danger">Cancel</a>
         </form>
<?php
}
?>
