...
?>
           ...
           <div class="container">
            ...
            <br>
              <form method="POST" action="update.php?id=<?php echo $row['id']; ?>&table=test&page=viewdata.php" enctype="multipart/form-data">
               <!--  
            ...
            <a href="viewdata.php" &table=test class="btn btn-danger">Cancel</a>
              </form>
              </div>
  </div>
