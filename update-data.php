...
?>
           ...
           <div class="container">
            ...
            <br>
              <form method="POST" action="update.php?id=<?php echo $row['id']; ?>&table=test&page=view-all-data.php" enctype="multipart/form-data">
               <!--  
            ...
            <a href="view-all-data.php" &table=test class="btn btn-danger">Cancel</a>
              </form>
              </div>
  </div>
