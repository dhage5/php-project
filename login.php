  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
                ...
                <div class="p-5">
                  ...
                  <form class="user" method="POST">
                   ...
                   <!--  <div class="form-group">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="firstname" name="firstname" placeholder="Enter ypurEmail Address..." required>
                    </div>
                    <div class="form-group">
      ...
      <button type="submit" class="btn" name="login_user">Login</button>
                    ...
                    <a href="i#" class="btn btn-google btn-user btn-block">
